...
stok = [
    {"nama": "kaos", "jumlah": 99},
    {"nama": "kemeja", "jumlah": 46},
    {"nama": "hoodie", "jumlah": 69},
]
...
def main():
    while True:
        ...
        if pilihan == "1":
            ...
            tambah = data.tambah_data_barang(stok, nama_benda, jumlah_benda)
            ...
            sukses = data.edit_data(stok, indeks, nama_baru, jumlah_baru)
            if sukses:
            ...
            berhasil = data.hapus_data(stok, indeks)
            if berhasil:
            ...
            hasil = data.cari_data(stok, nama)
            if hasil:
                print(f"Ditemukan: Nama = {hasil['nama']}, Jumlah = {hasil['jumlah']}")
            else:
                print("Barang tidak ditemukan.")
        elif pilihan == "5":
            data.tampilkan_data(stok)
        elif pilihan == "6":
            jumlah_data = data.hitung_jumlah_data(stok)
